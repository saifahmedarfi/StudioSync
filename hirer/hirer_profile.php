...
<head>
  ...
  <title>StudioSync | Hirer Profile</title>
...
<div class="profile-pic" style="background-image: url('../assets/hirercompany.png');"></div>
      <div class="profile-info">
        <h1>Mohapurush Inc.</h1>
    ...
    <div class="social-card">
      <a href="https://www.facebook.com/mohapurushinc" class="social-link social-facebook"><i class="fab fa-facebook"></i>Facebook</a>
      <a href="https://www.instagram.com/mohapurushinc/
" class="social-link social-instagram"><i class="fab fa-instagram"></i>Instagram</a>
      <a href="https://www.youtube.com/@mohapurushinc
" class="social-link social-youtube"><i class="fab fa-youtube"></i>YouTube</a>
      <a href="https://open.spotify.com/artist/mohapurushinc
" class="social-link social-spotify"><i class="fab fa-spotify"></i>Spotify</a>
      <a href="https://soundcloud.com/mohapurush-inc
" class="social-link social-soundcloud"><i class="fab fa-soundcloud"></i>SoundCloud</a>
    </div>


          <a href="../hirer/dashboard.php" class="bookings-btn">Go to Dashboard</a>

      <a href="../hirer/edit_profile.php" class="edit-profile-btn">Edit Profile</a>
    </section>
  </main>
